# Nama File: macan_conquer4_mod.py
# Deskripsi: Tools untuk maintenance dan perbaikan Windows 10/11.
# Dibuat dengan Python dan PySide6.
#
# Changelog (Modifikasi):
# - [FITUR] Ditambahkan System Info Dashboard untuk menampilkan OS, CPU, RAM, dan Uptime.
...
import shutil
import tempfile
# [BARU] Import yang diperlukan untuk System Info
import platform
import psutil
...
# [BARU] Import QTimer untuk update info secara real-time
...
class MacanConquerApp(QMainWindow):
    def __init__(self):
        ...
        # [MODIFIKASI] Ukuran jendela disesuaikan untuk menampung panel baru
    ...
    def init_ui(self):
        ...
        # --- [BARU] System Info Dashboard (diambil dari macan_conquer5.py) ---
    ...
    # --- [FUNGSI BARU] Diambil dari macan_conquer5.py ---
    ...
    def update_system_info(self):
        ...
        try:
            ...
            # Hentikan timer jika ada error (misal: psutil tidak terinstall)
            self.info_timer.stop()
            self.os_label.setText("Error. Pastikan 'psutil' terinstall.")
            self.add_log(f"❌ Gagal memuat info sistem: {e}")
    ...
    if is_admin():
        app_instance.setStyleSheet("""
            ...
            QPushButton {
                ...
                color: #e6e6e6;
                border: none;
                padding: 8px; /* Ukuran padding dikurangi dari 12px */
                border-radius: 6px;
                font-weight: bold;
            }
            QPushButton:hover {
