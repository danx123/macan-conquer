# Nama File: macan_conquer.py (Versi Profesional)
...
class MacanConquerApp(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 750, 800) # Ukuran window diubah agar lebih leluasa
    ...
    # --- [ (run_command, add_log, clear_temp, dll) ] ---
    # --- [ PENAMBAHAN FUNGSI BARU DI BAWAH INI ] ---
